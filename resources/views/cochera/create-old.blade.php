					...
					<form id="cocheraCreateForm" action="{{ route('cocheras.store') }}" method="POST">
						...
						<div class="row">
							...
							<div class="col-md-6">
								...
								<input type="text" name="placa" id="placa" class="form-control" value="{{ old('placa') }}" required maxlength="20" placeholder="Ej: ABC-123">
							</div>
						</div>
						<div class="row">
							<div class="col-md-4">
								<label for="modelo">Modelo <span class="text-danger">*</span></label>
								<input type="text" name="modelo" id="modelo" class="form-control" value="{{ old('modelo') }}" required maxlength="100" placeholder="Ej: Toyota Corolla">
							</div>
							<div class="col-md-4">
								<label for="color">Color <span class="text-danger">*</span></label>
								<input type="text" name="color" id="color" class="form-control" value="{{ old('color') }}" required maxlength="50" placeholder="Ej: Blanco">
							</div>
							<div class="col-md-4">
