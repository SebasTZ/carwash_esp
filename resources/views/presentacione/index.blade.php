...
<div class="container-fluid px-4">
    <h1 class="mt-4 text-center">Presentations</h1>
                            ...
                            <div class="d-flex justify-content-around">
                                <div>
                                    ...
                                    <ul class="dropdown-menu text-bg-light" style="font-size: small;">
                                        ...
                                        <li><a class="dropdown-item" href="{{route('presentaciones.edit',['presentacione'=>$item])}}">Edit</a></li>
                                        @endcan
                                    </ul>
                                </div>
                                <div>
                                ...
                                <div>
                                    ...
                                    @if ($item->caracteristica->estado == 1)
                                    <button title="Delete" data-bs-toggle="modal" data-bs-target="#confirmModal-{{$item->id}}" class="btn btn-datatable btn-icon btn-transparent-dark">
                                    ...
                                    @else
                                    <button title="Restore" data-bs-toggle="modal" data-bs-target="#confirmModal-{{$item->id}}" class="btn btn-datatable btn-icon btn-transparent-dark">
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    {{ $item->caracteristica->estado == 1 ? 'Are you sure you want to delete the presentation?' : 'Are you sure you want to restore the presentation?' }}
                                </div>
