...
<div class="container-fluid px-4">
    <h1 class="mt-4 text-center">Categories</h1>
                            ...
                            <div class="d-flex justify-content-around">
                                ...
                                <div>
                                    ...
                                    <ul class="dropdown-menu text-bg-light" style="font-size: small;">
                                        ...
                                        <li><a class="dropdown-item" href="{{route('categorias.edit',['categoria'=>$categoria])}}">Edit</a></li>
                                        @endcan
                                    </ul>
                                </div>
                                ...
                                <div>
                                    ...
                                    @if ($categoria->caracteristica->estado == 1)
                                    <button title="Delete" data-bs-toggle="modal" data-bs-target="#confirmModal-{{$categoria->id}}" class="btn btn-datatable btn-icon btn-transparent-dark">
                                    ...
                                    @else
                                    <button title="Restore" data-bs-toggle="modal" data-bs-target="#confirmModal-{{$categoria->id}}" class="btn btn-datatable btn-icon btn-transparent-dark">
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    {{ $categoria->caracteristica->estado == 1 ? 'Are you sure you want to delete the category?' : 'Are you sure you want to restore the category?' }}
                                </div>
