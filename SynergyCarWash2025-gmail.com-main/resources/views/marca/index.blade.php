...
<div class="container-fluid px-4">
    <h1 class="mt-4 text-center">Brands</h1>
                            ...
                            <div class="d-flex justify-content-around">
                                ...
                                <div>
                                    ...
                                    <ul class="dropdown-menu text-bg-light" style="font-size: small;">
                                        <!-----Edit brand--->
                                        @can('editar-marca')
                                        <li><a class="dropdown-item" href="{{route('marcas.edit',['marca'=>$item])}}">Edit</a></li>
                                        @endcan
                                    </ul>
                                </div>
                                <div>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    {{ $item->caracteristica->estado == 1 ? 'Are you sure you want to delete the brand?' : 'Are you sure you want to restore the brand?' }}
                                </div>
